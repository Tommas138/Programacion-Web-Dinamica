    ...
    <body>
        <?php
            if ($_GET) {
                ...
                $horasLunes = intval($_POST ['lunes_form']);
                $horasMartes = intval($_POST ['martes_form']);
                $horasMiercoles = intval($_POST ['miercoles_form']);
                $horasJueves = intval($_POST ['jueves_form']);
                $horasViernes = intval($_POST ['viernes_form' ]);
                $totalHoras = $horasLunes + $horasMartes + $horasMiercoles + $horasJueves + $horasViernes;
                echo "El total de horas fue de: " . $totalHoras;
            }
        ?>
